...
namespace Songhay.DataAccess.Extensions
{
    ...
    public static partial class IDataReaderExtensions
    {
        ...
        /// </summary>
        /// <param name="reader">The reader.</param>
        public static XDocument ToXDocument(this IDataReader reader)
        {
            return reader.ToXDocument(rootElementName: null, rowElementName: null);
        }
        ...
        public static XDocument ToXDocument(this IDataReader reader, string rootElementName)
        {
            return reader.ToXDocument(rootElementName, rowElementName: null);
        }
